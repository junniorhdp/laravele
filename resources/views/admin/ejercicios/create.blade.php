...
@section('content')
<h1 class="text-2xl font-bold mb-4">➕ Crear Ejercicio</h1>

<form action="{{ route('ejercicios.store') }}" method="POST" class="bg-white p-6 rounded shadow space-y-4">
  @csrf
  <div>
    <label>Nombre</label>
  ...
  <div>
    ...
    <input type="text" name="grupo_muscular" class="border rounded p-2 w-full" required>
  </div>
  <div>
