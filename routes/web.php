...
Route::middleware(['auth', 'role:usuario'])->group(function () {
    Route::get('/usuario', [UserController::class, 'show'])->name('usuario.show');
...
//  Profesional
// -----------------------------
Route::prefix('profesionales')
    ->middleware(['auth', 'role:profesional'])
    ->group(function () {
        Route::get('/', [ProfessionalController::class, 'index'])->name('profesionales.index');
